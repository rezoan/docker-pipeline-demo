...
NEW_TASK_DEFINTIION_Modified=`echo $NEW_TASK_DEFINTIION | sed "s/700707367057.dkr.ecr.us-east-1.amazonaws.com/php-demo:feature-feature01\r//g"`
echo "$NEW_TASK_DEFINTIION_Modified"
