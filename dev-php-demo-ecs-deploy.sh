...
NEW_TASK_DEFINTIION_OPTIMIZED=`echo $NEW_TASK_DEFINTIION | sed 's/\\\\r//g'`
echo "$NEW_TASK_DEFINTIION_OPTIMIZED"
NEW_TASK_INFO=$(aws ecs register-task-definition --region us-east-1 --cli-input-json "$NEW_TASK_DEFINTIION_OPTIMIZED")
